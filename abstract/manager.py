...
class Manager(abc.ABC):
    ...
    def __getitem__(self, name):
        ...
        Implementation of this dunder mathod allow us to access commands
        by name in the same way as it works in dictionary.
    ...
    def __contains__(self, name):
        ...
        Implementation of this dunder mathod allow us to use 'in' operator
